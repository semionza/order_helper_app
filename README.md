...
The interface supports English (`en`), Russian (`ru`), and Hebrew (`he`). Flutter selects the closest supported language from the device locale. Hebrew automatically uses RTL layout through Flutter's localization delegates.
